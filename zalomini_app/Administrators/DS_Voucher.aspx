<%@ Page Title="" Language="C#" MasterPageFile="~/Administrators/Site1.Master" AutoEventWireup="true" CodeBehind="DS_Voucher.aspx.cs" Inherits="zalomini_app.Administrators.DS_Voucher" %>
        ...
        <div class="d-flex">
          <asp:GridView CssClass="text-center" ID="GridView" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" Width="100%" marrgin-top="10px" AllowPaging="True" OnPageIndexChanging="GridView_PageIndexChanging" DataKeyNames="Id" OnRowDeleting="GridView_RowDeleting">
            <Columns>
                ...
                <asp:TemplateField>
                    <ItemTemplate>
                        <a class="Edit" href="edit_Voucher.aspx?id=<%# Eval("Id") %>">Edit</a>
                    </ItemTemplate>
                </asp:TemplateField>
