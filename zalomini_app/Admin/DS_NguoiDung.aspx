<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Site1.Master" AutoEventWireup="true" CodeBehind="DS_NguoiDung.aspx.cs" Inherits="zalomini_app.Admin.DS_NguoiDung" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container" >
        ...
        <div class="actions">
            ...
            <a href="Add_NguoiDung.aspx" id="btnadd" class="add-btn">Thêm Người Dùng</a>
            <div class="sort-box">
        ...
        <div class="sort_search">
            <label for="search">
                Tìm kiếm:
               <asp:TextBox ID="Search" runat="server" placeholder="Tìm kiếm Người Dùng"></asp:TextBox>
            </label>
        ...
        <div class="d-flex">
                <asp:GridView CssClass="text-center" ID="GridView" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" Width="100%" marrgin-top="10px" AllowPaging="True" OnPageIndexChanging="GridView_PageIndexChanging" DataKeyNames="Id" OnRowDeleting="GridView_RowDeleting">
                    <Columns>
                        ...
                        <asp:TemplateField>
                            <ItemTemplate>
                                <a class="Edit" href="Edit_NguoiDung.aspx?id=<%# Eval("Id") %>">Sửa</a>
                            </ItemTemplate>
                        </asp:TemplateField>
