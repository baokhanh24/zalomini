<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Site1.Master" AutoEventWireup="true" CodeBehind="DS_DotThi.aspx.cs" Inherits="zalomini_app.Admin.DS_DotThi" %>
        ...
        <div class="d-flex">
          <asp:GridView CssClass="text-center" ID="GridView" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" Width="100%" marrgin-top="10px" AllowPaging="True" OnPageIndexChanging="GridView_PageIndexChanging" DataKeyNames="Id" OnRowDeleting="GridView_RowDeleting">
            <Columns>
                ...
                <asp:TemplateField>
                    <ItemTemplate>
                        <a class="Edit" href="edit_DotThi.aspx?id=<%# Eval("Id") %>">Sửa</a>
                    </ItemTemplate>
                </asp:TemplateField>
