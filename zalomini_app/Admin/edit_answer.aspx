<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Site1.Master" AutoEventWireup="true" CodeBehind="edit_answer.aspx.cs" Inherits="zalomini_app.Admin.edit_answer" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="edit_answerall" >
        <asp:Label ID="lblError" runat="server">
        </asp:Label>
        <div class="header">
            <a href="DSanswer.aspx" class="edit_Dsanswer"><i class='bx bxs-chevron-left'></i> Quay Lại</a>
            <h2>Sửa câu hỏi</h2>
        </div>
        ...
        <label for="dapan" class="DapAn">
            ...
            <div class="Answer">
                <div>
                   ...
                   <asp:RadioButton ID="optionA" runat="server"  GroupName="DapAn" Value="1" OnCheckedChanged="optionA_CheckedChanged" AutoPostBack="True" />
                    
                </div>
                <div>
                    <label for="optionB">B</label>
                   <asp:RadioButton ID="optionB" runat="server" GroupName="DapAn" Value="2" OnCheckedChanged="optionB_CheckedChanged" AutoPostBack="True" />
                    
                </div>
                <div>
                    <label for="optionC">C</label>
                   <asp:RadioButton ID="optionC" runat="server" GroupName="DapAn" Value="3" OnCheckedChanged="optionC_CheckedChanged" AutoPostBack="True"/>
                    
                </div>
                <div>
                    <label for="optionD">D</label>
                   <asp:RadioButton ID="optionD" runat="server" GroupName="DapAn" Value="4" OnCheckedChanged="optionD_CheckedChanged" AutoPostBack="True"/>
